...
MRIQC_MEGE_BASHFILE = '/Shared/lss_kahwang_hpc/scripts/preprocessing/mriqc/mriqc_mege_base.sh'
...
FMRIPREP_MEGE_BASHFILE = '/Shared/lss_kahwang_hpc/scripts/preprocessing/fmriprep/fmriprep_mege_base.sh'
